...
const PharmacyWholesalerForm = () => {
  ...
  const { type, typeName, category, categoryName } = route.params || {}; console.log({ type, typeName, category, categoryName });
  ...
  const validateForm = () => {
    ...
    if (!formData.license20b) newErrors.license20 = 'License 20 number is required';
    if (!formData.license20bFile) newErrors.license20File = 'License 20 upload is required';
    if (!formData.license20bExpiryDate) newErrors.license20ExpiryDate = 'License 20 expiry date is required';
    if (!formData.license21b) newErrors.license21 = 'License 21 number is required';
    if (!formData.license21bFile) newErrors.license21File = 'License 21 upload is required';
    if (!formData.license21bExpiryDate) newErrors.license21ExpiryDate = 'License 21 expiry date is required';
