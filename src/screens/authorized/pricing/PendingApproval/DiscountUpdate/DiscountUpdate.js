...
import DiscountUpdateList from './DiscountUpdateList';
import DiscountUpdateDetail from './DiscountUpdateDetail';
...
const DiscountUpdate = () => {
  ...
  const handleApprove = () => {
    setToastMessage('Updated discount has been approved!');
    setShowToast(true);
    setCurrentView('list');
