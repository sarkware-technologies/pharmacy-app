...
const styles = StyleSheet.create({
  ...
  productName: { fontSize: 14, fontWeight: '600', color: colors.primaryText },
  ...
  metricLabel: { fontSize: 10, color: colors.secondaryText, marginBottom: 4, fontWeight: 400, fontFamily: Fonts.Regular },
  metricValue: { fontSize: 12, color: colors.secondaryText, fontWeight: '600', fontFamily: Fonts.Bold },
...
export default SearchAndProduct;
