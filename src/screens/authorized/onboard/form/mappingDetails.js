                ...
                <AppView style={OnboardStyle.accordionView}>
                    ...
                    {(formData?.typeId == 2 && ((formData?.categoryId == 4 && formData?.subCategoryId == 3) || formData?.categoryId == 5)) && (
                        <AppView>
                            ...
                            <FloatingDropdown style={{ borderRadius: 12 }} label={"Search Hospital name/code"} onPress={() => { }} />
                            <View>
                    ...
                    {(formData?.typeId == 1 || formData?.typeId == 3) && (
                        <AppView>
                            <AppView marginTop={30} marginBottom={4} flexDirection={"row"} gap={30}>
                                <RadioOption width={15} height={15} label={<AppText fontSize={16} fontWeight={"bold"}>Hospital</AppText>} />
                                {formData?.typeId == 1 && (
                                    <RadioOption width={15} height={15} label={<AppText fontSize={16} fontWeight={"bold"}>Doctor</AppText>} />
                                )}
                                {formData?.typeId == 3 && (
                                    <RadioOption width={15} height={15} label={<AppText fontSize={16} fontWeight={"bold"}>Pharmacy</AppText>} />
                                )}
                            </AppView>
                            <FloatingDropdown style={{ borderRadius: 12 }} label={"Search hospital name/code"} onPress={() => { }} />
                            <View>
                            ...
                            <FloatingDropdown style={{ borderRadius: 12 }} label={"Search doctor name/code"} onPress={() => { }} />
                            <View>
                                <TextButton fontWeight={600} fontFamily="regular">+ Add New doctor</TextButton>
                            </View>
                            <FloatingDropdown style={{ borderRadius: 12 }} label={"Search pharmacy name/code"} onPress={() => { }} />
                            <View>
